...
- **Frontend**: Cursor agent + tests/review (no rewriting tests to pass, no hard coding and mocking)
...
**File Size**: Keep files <~500 LOC. Split/refactor when exceeded. Target: readable, modular, reusable components.

**Readability**: Clear naming, single responsibility, avoid deeply nested logic.
...
## 9. Quick Tasks (1-hr deliverables)
